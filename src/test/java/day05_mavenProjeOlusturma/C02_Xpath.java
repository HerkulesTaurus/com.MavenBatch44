...
public class C02_Xpath {
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//*[@id='sp_amount']")).sendKeys("$50000000");
        ...
        WebElement mesajCiktiMi = driver.findElement(By.xpath("//*[@id='alert_content']"));
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));

        if (mesajCiktiMi.isDisplayed()){
            System.out.println("mesaj cikti -->PASS");
        }else{
            System.out.println("mesaj cikmadi -->FAİLURE");
        }
